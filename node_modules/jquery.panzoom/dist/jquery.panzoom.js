  ...
  Panzoom.prototype = {
    ...
    setMatrix: function(matrix, options) {
      ...
      if (contain) {
        ...
        var spaceHBottom =
          (height - conHeight) / 2 - dims.border.top - dims.border.bottom;

        if (
          contain === "invert" ||
          (contain === "automatic" && zoomAspectW < 1.01)
        ) {
          matrix[4] = Math.max(
            Math.min(matrix[4], spaceWLeft - dims.border.left),
            -spaceWRight
          );
        } else {
        ...
        if (
          contain === "invert" ||
          (contain === "automatic" && zoomAspectH < 1.01)
        ) {
          matrix[5] = Math.max(
            Math.min(matrix[5], spaceHTop - dims.border.top),
            -spaceHBottom
          );
        } else {
    ...
    zoom: function(scale, opts) {
      ...
      this.setMatrix(matrix, {
        animate:
          typeof options.animate !== "undefined" ? options.animate : animate,
    ...
    _bind: function() {
      ...
      var str_down =
        "mousedown" + ns + " pointerdown" + ns + " MSPointerDown" + ns;
          ...
          if (
            e.type === "touchstart"
              ...
              : // Mouse/Pointer: Ignore unexpected click types
                ...
                !options.disablePan &&
                (e.which || e.originalEvent.which) === options.which
          ) {
            e.preventDefault();
            e.stopPropagation();
